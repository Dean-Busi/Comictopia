          ...
          <View style={styles.textBox}>
            <Text style={styles.description}>
              <View style={styles.superheroFlexbox}>
                <Image
                  source={require("../../assets/images/Marvel_Characters/hulk.webp")}
                  style={styles.characterImage}
                />
                <Text style={styles.ersterAuftritt}>Erster Auftritt: 1962</Text>
                <Image
                  source={require("../../assets/images/Marvel_Characters/hulk_liveAction.png")}
                  style={styles.liveActionImage}
                />
              </View>
              {"\n"}
              Der Incredible Hulk, alias Dr. Bruce Banner, ist ein brillanter
              Wissenschaftler, der sich nach einem Unfall mit Gammastrahlung in
              ein gewaltiges grünes Wesen verwandelt, wenn er wütend wird. Hulk
              besitzt immense Stärke und Unverwundbarkeit, aber seine
              Transformation macht ihn unberechenbar und gefährlich. Banner
              kämpft darum, die Kontrolle über das Monster in sich zu behalten,
              während Hulk als mächtiger Verbündeter der Avengers die Erde gegen
              Bedrohungen verteidigt.
            </Text>
          </View>
        </View>
